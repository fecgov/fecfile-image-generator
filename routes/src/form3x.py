...
def process_schedules(f3x_data, md5_directory, total_no_of_pages):
    ...
    sc_sa_line_numbers = ['16G', '16F', '16L']
    sc_sb_line_numbers = ['22L', '22J', '22G', '22H']
    sa_schedules = []
    sb_schedules = []
                ...
                for sc_count in range(sc_schedules_cnt):
                    if 'child' in sc_schedules[sc_count]:
                        ...
                        for sc_child_count in range(sc_child_schedules_count):
                            if sc_schedules[sc_count]['child'][sc_child_count]['lineNumber'] in sc_sa_line_numbers:
                                sa_schedules.append(sc_schedules[sc_count]['child'][sc_child_count])
                            elif sc_schedules[sc_count]['child'][sc_child_count]['lineNumber'] in sc_sb_line_numbers:
                                sb_schedules.append(sc_schedules[sc_count]['child'][sc_child_count])
