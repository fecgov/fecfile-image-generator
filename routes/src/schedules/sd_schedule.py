        ...
        for line_number in sd_dict:
            ...
            for index in range(len(sd_list)):
                ...
                if (
                    ...
                    and sd_list[index].get("creditorOrganizationName") != ""
                ):
                    sd_page_dict["creditorName_{}".format(concat_no)] = sd_list[
                        index
                    ].get("creditorOrganizationName")
                else:
                ...
                for item in [
                    ...
                    sd_page_dict[item + "_{}".format(concat_no)] = sd_list[index].get(
                        item
                    )
