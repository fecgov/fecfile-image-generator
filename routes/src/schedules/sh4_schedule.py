...
def print_sh4_line(f3x_data, md5_directory, line_number, sh4_list, page_cnt, start_page,
                    total_no_of_pages):
    ...
    if sh4_list:
        ...
        for page_num in range(page_cnt):
            ...
            build_sh4_per_page_schedule_dict(last_page, last_page_cnt,
            ...
            schedule_page_dict['subTotalFedNonFedShare'] = '{0:.2f}'.format(page_fed_subtotal+page_nonfed_subtotal)
            ...
            if page_cnt == page_num + 1:
                ...
                schedule_page_dict['totalNonFedShare'] = '{0:.2f}'.format(total_nonfedshare)
                schedule_page_dict['TotalFedNonFedShare'] = '{0:.2f}'.format(total_fedshare+total_nonfedshare)
            schedule_page_dict['committeeName'] = f3x_data['committeeName']
            sh4_outfile = md5_directory + 'SH4/' + line_number + '/page_' + str(page_num) + '.pdf'
            ...
            current_page_num = build_memo_page(memo_array,
                                               ...
                                               current_page_num, page_num,
                                               total_no_of_pages, sh4_outfile, name='SH4')
...
def build_sh4_per_page_schedule_dict(last_page, transactions_in_page, page_start_index, schedule_page_dict,
