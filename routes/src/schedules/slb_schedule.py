...
def print_slb_line(f3x_data, md5_directory, line_number, slb_list, page_cnt, start_page,
                total_no_of_pages):
    try:
        if slb_list:
            ...
            for page_num in range(page_cnt):
                ...
                build_slb_per_page_schedule_dict(last_page, last_page_cnt,
                ...
                slb_outfile = md5_directory + 'SL-B/' + line_number + '/page_' + str(page_num) + '.pdf'
                ...
                if len(memo_array) >= 1:
                    ...
                    memo_outfile = md5_directory + 'SL-B/' + line_number + '/page_memo_' + str(page_num) + '.pdf'
...
def build_slb_per_page_schedule_dict(last_page, transactions_in_page, page_start_index, schedule_page_dict,
...
def build_slb_name_date_dict(index, key, schedule_dict, schedule_page_dict):
    try:
        ...
        print('Error at key: ' + key + ' in Schedule-LB transaction: ' + str(schedule_dict))
        raise e
