...
def build_sh5_per_page_schedule_dict(
    ...
    schedule_page_dict["subtotalAmountTransferred"] = "{0:.2f}".format(
        transferred_amt_subtotal
    )
    schedule_page_dict["subvoterRegistrationAmount"] = "{0:.2f}".format(
    ...
    schedule_page_dict["subgenericCampaignAmount"] = "{0:.2f}".format(
