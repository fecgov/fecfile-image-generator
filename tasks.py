...
APP_NAME = "fecfile-image-generator"
...
DEPLOY_RULES = (
    ...
    ('dev', lambda _, branch: branch == 'feature/28-deploy-to-cloud.gov'),
)
...
def _login_to_cf(ctx, space):
    ...
    if result.return_code != 0:
        ...
        print("   cf login -u [email-address] -o {ORG_NAME} -a api.fr.cloud.gov --sso")
        print("   cf target -o {ORG_NAME} -s {space}")
